...
/*!
 * @file S32K324_DCM_GPR.h
 * @version 1.1
 * @date 2021-10-21
 * @brief Peripheral Access Layer for S32K324_DCM_GPR
 *
...
#if !defined(S32K324_DCM_GPR_H_)  /* Check if memory map has not been already included */
#define S32K324_DCM_GPR_H_
...
#endif  /* #if !defined(S32K324_DCM_GPR_H_) */
