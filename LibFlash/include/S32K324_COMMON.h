...
#if !defined(S32K324_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K324_COMMON_H_
#define MCU_S32K324

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32K324 memory map: There is already included another memory map. Only one memory map can be included.
...
#endif  /* #if !defined(S32K324_COMMON_H_) */
