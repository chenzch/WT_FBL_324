...
const boot_header_t __attribute__((section(".boot_header")))
...
const boot_header_t
    ...
    boot_header = {
        ...
        .BootConfig = (CM7_0_ENABLE << CM7_0_ENABLE_SHIFT) | (CM7_1_ENABLE << CM7_1_ENABLE_SHIFT) |
                      (CM7_2_ENABLE << CM7_2_ENABLE_SHIFT), /* Boot configuration word */
...
#elif defined(__GNUC__) || defined(__DCC__)
static const lc_config_t __attribute__((section(".boot_header")))
#elif defined(__ICCARM__)
#pragma location = ".boot_header"
static const lc_config_t
#endif
...
#elif defined(__GNUC__) || defined(__DCC__)
static const xrdc_config_t __attribute__((section(".boot_header")))
#elif defined(__ICCARM__)
#pragma location = ".boot_header"
static const xrdc_config_t
#endif
    xrdc_config = {.Header = 0xffffffff};
